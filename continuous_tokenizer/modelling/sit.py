...
class SiTBlock(nn.Module):
    ...
    def forward(self, x, c):
        shift_msa, scale_msa, gate_msa, shift_mlp, scale_mlp, gate_mlp = (
            self.adaLN_modulation(c).chunk(6, dim=-1)#https://zhuanlan.zhihu.com/p/685867473 ,图2的adaLN，从下往上看
        )
...
class SiT(nn.Module, PyTorchModelHubMixin):
    ...
    def forward(self, x, t, y, return_logvar=False, return_mid_feat=None):#forward输入的是加入噪声的隐藏层，t是时间步，y是标签
        """
        Forward pass of SiT.
