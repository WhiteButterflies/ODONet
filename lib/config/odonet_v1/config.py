...
cfg.MODEL.ENCODER.DEFORM_INDEXES = [2]
...
cfg.TRAIN.POS_L1_WEIGHT = 1.0 #weight added for offset l1 loss
cfg.TRAIN.OFFSET_L1_WEIGHT = 1.0 #weight added for offset l1 loss
cfg.TRAIN.OFFSET_COSINE_WEIGHT = 1.0 #weight added for offset cosine loss
cfg.TRAIN.SIMCLR_WEIGHT = 1.0 #weight added for InoNCE loss
cfg.TRAIN.PRINT_INTERVAL = 50 # interval to print the training logs
...
cfg.DATA.VAL.SAMPLE_PER_EPOCH = 500

# DATA.SEARCHES
cfg.DATA.SEARCHES = 3
cfg.DATA.SEARCHES_PREDICT = 2
# DATA.SEARCH
