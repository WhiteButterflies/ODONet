...
def analyze_tracking_causality(seq_dir, output_dir="results4"):
...
if __name__ == "__main__":
    ...
    # seq_path = "/data2/lqh/workspace_pycharm/MCITrack/vis/chotrack_b224_got_a100/Basketball/causal_data"
