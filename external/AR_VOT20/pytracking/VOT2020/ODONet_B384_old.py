...
run_vot_exp('mcitrack_h_deform_online_v5', 'mcitrack_b384_3090', 'baseline_plus_got_lasot', 0.40, VIS=False, trt='false')
# run_vot_exp('odonet_v1', 'odonet_b384', 'baseline_plus_got_lasot', 0.40, VIS=False, trt='false')
